...
# Generate Java classes (package 't2d' as declared in proto) for potential future direct Java usage
protoc --java_out="$OUT_JAVA_DIR" -I "$PROTO_DIR" "$PROTO_DIR/game.proto"
